...
hidden if the `crillab-autis_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `crillab-autis_DEVELOPER_MODE` to the configure
